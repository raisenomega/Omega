...
> **Audit rendimiento imagen (26 may):** +4 DEBTs (068-071) · **DEBT-068 CERRADA** (uploads async · el P0 de escala · ver §2). Quedan: 🔴 DEBT-069 (sin timeout Nano Banana) · 🟠 DEBT-070 (rate-limit config muerta · P1) + DEBT-071 (cero retry/fallback).

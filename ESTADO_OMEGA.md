...
## 🟢 DEBT-ANALYTICS-OAUTH-PER-CLIENT (Google ✅ CERRADO 23 jun · Meta → DEBT-...-META abierto)
...
## 🟡 ARCO 2 · CONNECT GOOGLE+META (INSIGHTS) — CÓDIGO COMPLETO en prod (`d695abc`) · ⚠️ UTILIDAD EN DUDA vs ARCO 3 ADS — **PRÓXIMA SESIÓN ARRANCA ACÁ: decidir qué hacer con el Arco 2 (read-only · mantener/retirar/refactor) ANTES de nada**

...
-- ║                                                                    ║
-- ║  Constraint UNIQUE (category, vertical, platform, version):        ║
-- ║   · 26 prompts con version=1 (default)                             ║
-- ║   · 4 prompts con version=2 (combos duplicados · segundo mejor)    ║
-- ║                                                                    ║
-- ║  ON CONFLICT DO NOTHING → idempotente · re-aplicable sin error.    ║
-- ╚═══════════════════════════════════════════════════════════════════╝

INSERT INTO prompt_vault (category, vertical, platform, agent_code, performance_score, version, prompt_text)
VALUES
('script', 'construction', 'instagram', 'RAFA', 9.2, 1,
...
('caption', 'restaurant', 'instagram', 'RAFA', 9.1, 1,
...
('caption', 'real_estate', 'instagram', 'RAFA', 9.0, 1,
...
('script', 'restaurant', 'instagram', 'RAFA', 9.0, 1,
...
('caption', 'health', 'instagram', 'RAFA', 8.9, 1,
...
('caption', 'construction', 'instagram', 'RAFA', 8.8, 1,
...
('script', 'restaurant', 'tiktok', 'RAFA', 8.8, 1,
...
('script', 'real_estate', 'instagram', 'RAFA', 8.7, 1,
...
('caption', 'restaurant', 'instagram', 'RAFA', 8.7, 2,
...
('script', 'health', 'instagram', 'RAFA', 8.6, 1,
...
('caption', 'real_estate', 'instagram', 'RAFA', 8.5, 2,
...
('story', 'restaurant', 'instagram', 'RAFA', 8.5, 1,
...
('caption', 'health', 'instagram', 'RAFA', 8.4, 2,
...
('story', 'construction', 'instagram', 'RAFA', 8.3, 1,
...
('ad', 'restaurant', 'facebook', 'RAFA', 8.3, 1,
...
('ad', 'real_estate', 'facebook', 'RAFA', 8.2, 1,
...
('story', 'health', 'instagram', 'RAFA', 8.1, 1,
...
('ad', 'construction', 'facebook', 'RAFA', 8.1, 1,
...
('story', 'real_estate', 'instagram', 'RAFA', 8.0, 1,
...
('caption', 'construction', 'instagram', 'RAFA', 7.9, 2,
...
('email', 'real_estate', 'email', 'RAFA', 7.8, 1,
...
('post', 'construction', 'linkedin', 'RAFA', 7.7, 1,
...
('email', 'restaurant', 'email', 'RAFA', 7.7, 1,
...
('email', 'construction', 'email', 'RAFA', 7.6, 1,
...
('post', 'real_estate', 'linkedin', 'RAFA', 7.5, 1,
...
('post', 'restaurant', 'google_business', 'RAFA', 7.5, 1,
...
('post', 'health', 'linkedin', 'RAFA', 7.4, 1,
...
('hashtags', 'real_estate', 'instagram', 'RAFA', 7.2, 1,
...
ON CONFLICT (category, vertical, platform, version) DO NOTHING;

-- Verificación inline (silenciosa · solo para debug humano)
-- SELECT COUNT(*) AS total_prompts FROM prompt_vault;
-- Esperado: 30 (si no había nada previo) · más si ya existían

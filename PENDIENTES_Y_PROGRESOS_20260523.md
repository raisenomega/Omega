...
| DEBT-CL-021 | 5 archivos fuera de cluster ARIA con `supabase.auth.getSession` directo | ✅ CERRADA 24 may 2026 Sprint 3 (4 archivos refactor a apiGet/apiPost/apiDelete · `useAuth.tsx` preservado · -56L netos · commit `af1dfcd`) | — |
| DEBT-CL-022 | `GenerateContentSheet.tsx` no enviaba `client_id` en payload `/content-lab/generate` · backend caía al fallback arbitrario (variante DEBT-CL-005 para sheet legacy desde dashboard) | ✅ CERRADA 24 may 2026 Sprint 3 (mismo commit DEBT-CL-021 · prop `clientId?: string` opcional + payload condicional) | — |
...
| DEBT-CL-010 | Video polling cancelable mid-flight · orphan visual | ✅ CERRADA Sprint 3 (B+a · backend DELETE + frontend cancel + useEffect cleanup auto) | — |
| DEBT-CL-011 | Nano Banana ImageConfig removida en 1.2 · existe en 2.6 (re-activar) | ✅ CERRADA Sprint 3 | — |
| DEBT-CL-012 | Download imagen/video posible CORS · verificar | ✅ VERIFICADA OK Sprint 3 (bucket public + Supabase CORS auto + persisted URLs · cero bug) | — |

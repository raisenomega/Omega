...
export function useClientPlanStatus(clientId: string): PlanStatusData {
  ...
  // Fuente única y canónica: client_plans.plan. Default a 'adopcion' (entry tier · spec §3)
  // cuando no hay row: cliente pre-activación ve la bar con valores zero del trial de 7 días.

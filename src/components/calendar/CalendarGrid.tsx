  ...
  return (
    <div className="space-y-1">
      ...
      <div className="grid grid-cols-7 gap-1">
        {cells.map((c, i) => {
          if (!c.dateKey) return <div key={i} className="h-24" />;
          ...
          return (
            <button
              ...
              className={cn(
                "h-24 rounded border border-border/40 p-1 flex flex-col items-center justify-start text-xs hover:bg-muted/50 transition",

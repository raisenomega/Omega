  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-3 gap-3">
        <div className="space-y-1"><Label>Tono</Label>
        ...
        <div className="space-y-1"><Label>Emojis</Label>
        ...
        <div className="space-y-1"><Label>Hashtags</Label>
      ...
      <div className="space-y-1"><Label>Keywords (separados por coma)</Label>
        <Input value={(v?.brand_voice_keywords ?? []).join(", ")} onChange={(e) => form.setValue("brand_voice.brand_voice_keywords", e.target.value.split(",").map((s) => s.trim()).filter(Boolean))} /></div>
      <div className="space-y-1"><Label>Temas a evitar</Label>
        <Textarea value={v?.avoided_topics ?? ""} onChange={(e) => form.setValue("brand_voice.avoided_topics", e.target.value)} rows={2} /></div>
      <div className="space-y-2"><Label>Formatos preferidos</Label>

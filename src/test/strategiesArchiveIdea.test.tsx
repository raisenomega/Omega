...
describe("Fase C.2 Commit 2 · Archivar idea + Archivadas = ideas", () => {
  ...
  it("test_archivadas_sin_botones · en Archivadas (archived=true) la card NO tiene botones (Eliminar = C.3)", () => {
    ...
    expect(screen.getByText("texto de la idea")).toBeTruthy();   // sigue mostrando la idea
  });

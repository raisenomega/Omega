...
async def _resolve_client_id(authorization: Optional[str]) -> str:
    """JWT → cliente propio del usuario. 403 si el usuario no tiene cliente (mismo patrón OAuth)."""

# TEMP · DEBT-ZERNIO-CAPTURE-ENDPOINT-TEMP · REMOVER tras capturar el contrato headless.
# Endpoint efímero de captura del retorno OAuth headless de Zernio (experimento controlado).

...
Implementación real pendiente Fase 3 (query supabase agent_executions table).
...
async def handle_get_executions(agent_id: str):
    """Stub · DEBT-030 · handler no implementado."""
    raise HTTPException(
        status_code=501,
        detail="handle_get_executions not implemented · DEBT-030 · Fase 3"
    )

...
class ScheduledPostV3Create(BaseModel):
    ...
    media_url: Optional[str] = Field(default=None, description="URL Storage compartida entre todos los N posts del bloque · doble-escritura = media_urls[0]")
    media_urls: Optional[list[str]] = Field(default=None, description="Pieza 2 · carrusel: array de N media. None/[] → cae a media_url single (retrocompat). El publicador (capa 2) manda los N a Zernio")
